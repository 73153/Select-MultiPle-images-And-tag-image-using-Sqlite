...
const CGFloat kSDSegmentedControlArrowSize = 8;
const CGFloat kSDSegmentedControlInterItemSpace = 10;
...
- (void)commonInit
{
    ...
    segmentedControlAppearance.backgroundColor = [UIColor colorWithPatternImage:[UIImage imageNamed:@"header"]];
    segmentedControlAppearance.borderColor = [UIColor clearColor];
//    segmentedControlAppearance.arrowSize = 20;
//    segmentedControlAppearance.arrowHeightFactor = -1;
    
//    segmentedControlAppearance.arrowHeightFactor = 0.7;
    segmentedControlAppearance.titleFont = [UIFont fontWithName:@"Avenir-Medium" size:15.0];
    segmentedControlAppearance.selectedTitleFont = [UIFont fontWithName:@"Avenir-Medium" size:15.0];
    ...
    stainViewAppearance.backgroundColor =  [UIColor colorWithPatternImage:[UIImage imageNamed:@"header"]];
...
- (void)layoutSegments
{
    ...
    currentItemPosition += spaceLeft / 4;
...
+ (void)initialize
{
    ...
    [appearance setTitleColor:yourColor forState:UIControlStateSelected];
    [appearance setTitleColor:yourColor forState:UIControlStateDisabled];

    if (!SD_IS_IOS7)
    {
        UIColor *yourColor = [UIColor colorWithRed:77.0f/255.0f green:22.0f/255.0f blue:114.0f/255.0f alpha:1];

        [appearance setTitleShadowColor:yourColor forState:UIControlStateNormal];
        [appearance setTitleShadowColor:yourColor forState:UIControlStateSelected];
...
+ (void)initialize
{
    ...
    appearance.edgeInsets = UIEdgeInsetsMake(0, 0, 0, 0);
