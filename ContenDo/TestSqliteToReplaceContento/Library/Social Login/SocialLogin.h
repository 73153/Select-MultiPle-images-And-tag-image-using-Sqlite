...
//  Copyright (c) 2015 73153solutions. All rights reserved.
//
// Library used :
...
@interface SocialLogin : NSObject <UIWebViewDelegate>
...
@property (nonatomic,copy) google_completion_block objGoogleBlock;
@property (nonatomic,copy) instagram_completion_block objInstagramBlock;
